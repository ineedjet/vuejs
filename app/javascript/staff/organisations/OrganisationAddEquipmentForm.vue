...
<script>
 import titleInput from './OrganisationAddEquipmentFormTitleInput.vue';
 import kindInput from './OrganisationAddEquipmentFormKindInput.vue';
 import snInput from './OrganisationAddEquipmentFormSNInput.vue';
